...
public class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    private PullToRefreshRecyclerView mXrecyclerView;

    public SimpleItemTouchHelperCallback(ItemTouchHelperAdapter adapter, PullToRefreshRecyclerView recyclerView) {
        mAdapter = adapter;
